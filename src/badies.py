...
class Rock(VectorSprite):
    ...
    def createPointList(self):
        ...
        if (Rock.rockShape == 1):
            ...
            pointlist = [(-6,-12), (1,-5), (8, -12), (15, -5), (12,0), (15,6), (5,13), (-7,13), (-14,7), (-14,-5)]
            
        elif (Rock.rockShape == 3):
            pointlist = [(-7,-12), (1,-9), (8,-12), (15,-5), (8,-3), (15,4), (8,12), (-3,10), (-6,12), (-14,7), (-10,0), (-14,-5)]

        elif (Rock.rockShape == 4):
            pointlist = [(-7,-11), (3,-11), (13,-5), (13,-2), (2,2), (13,8), (6,14), (2,10), (-7,14), (-15,5), (-15,-5), (-5,-5), (-7,-11)]
